...
#         '''Add your code here to complete this route'''
#         try:
#             mongo.getAllInRange(self,start, end)
#             return jsonify({"status":"not found","dat":data})
#         except Exception as e:
#             print(f"get_all error: f{str(e)}")
...
#         '''Add your code here to complete this route'''
#         try:
#             mongo.temperatureMMAR(start, end)
#             return jsonify({"status":"not found","dat":data})
#         except Exception as e:
...
#         '''Add your code here to complete this route'''
#         try:
#             mongo.humidityMMAR(start, end)
#             return jsonify({"status":"not found","data":data})
#         except Exception as e:
